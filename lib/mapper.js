...
/**
 * Contains a mapping function that converts a result set into an array
 * of objects
...
/**
 * Returns a function for converting a result set into an array of model instances
...
exports.mapToModel = (Model, client) => {
    return (resultSet) => {
        return mapResultSet(resultSet, (resultSet, columns) => {
            ...
            const id = dataTypes.get(idMapping.type).get(resultSet, position);
