...
const defineModel = (client, type, mapping) => {
    ...
    const sqlTemplates = templates.buildTemplates(mapping);
    ...
    Object.defineProperties(ctor, {
        ...
        "mapTo": {
            "value": (resultSet) => {
                return mapper.mapResultSet(resultSet, (resultSet, columns) => {
                    const data = mapper.mapRow(resultSet, columns);
        ...
        "query": {
            "value": (clause, params) => {
                return SqlTemplate.newInstance(templates.buildQueryTemplate(mapping, clause))
                        .setMapper(ctor.mapTo)
    ...
    const ctorPropertyDefinitions = {
        ...
        "save": {
            "value": function() {
                ...
                const data = SqlTemplate.newInstance(sqlTemplate)
