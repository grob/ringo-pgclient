 ...
 * @param {String} template The sql template to parse, using '#{<name>}' parameter
 * placeholders
 * @return {Object} The parsed SQL query template
 */
...
/**
 * Returns a new SqlTemplate (in contrast to #build this method expects the
 * template descriptor returned by #parse).
